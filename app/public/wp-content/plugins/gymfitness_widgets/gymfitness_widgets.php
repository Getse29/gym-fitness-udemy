...
/* 
    ...
    Version: 1.0.0
    Author: GetseWeb (Josué Getsemani Sandoval Villarreal)
    Author URI: https://twitter.com/getseWeb
...
?>
  ...
  public function form($instance){
    ...
    $cantidad = ! empty($instance['cantidad']) ? $instance['cantidad'] : esc_html__('¿Cuántas clases desea mostrar?', 'gymfitness'); ?>
    <p>
